        ...
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Certifique-se de inserir uma senha grande e com caracteres especiais para sua segurança.
                </p>
            </header>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <p className="text-sm text-green-600 dark:text-green-400">Nova senha salva com sucesso!</p>
                    </Transition>
                </div>
            </form>
        </section>
